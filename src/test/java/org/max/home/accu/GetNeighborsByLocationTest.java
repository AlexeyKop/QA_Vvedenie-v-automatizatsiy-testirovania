...
import org.max.home.accu.AbstractTest;
...
public class GetNeighborsByLocationTest extends AbstractTest {

    private static final Logger logger
            = LoggerFactory.getLogger(GetNeighborsByLocationTest.class);
    ...
    void get_shouldReturn200() throws IOException, URISyntaxException {
        ...
        logger.debug("Формирование мока для GET /locations/v1/cities/neighbors/295954");
        stubFor(get(urlPathEqualTo("/locations/v1/cities/neighbors/295954"))
        ...
        HttpGet request = new HttpGet(getBaseUrl()+"/locations/v1/cities/neighbors/295954");
        ...
        verify(2, getRequestedFor(urlPathEqualTo("/locations/v1/cities/neighbors/295954")));
    ...
    void get_shouldReturn401() throws IOException, URISyntaxException {
        ...
        logger.debug("Формирование мока для GET /locations/v1/cities/neighbors/295954");
        // создаем Мок
        stubFor(WireMock.get(urlPathEqualTo("/locations/v1/cities/neighbors/295954"))
        ...
        URI uri = new URIBuilder(request.getURI())
                .addParameter("apiKey", "Q_82c9229354f849e78efe010d94150807")
                .build();
        request.setURI(uri);
        ...
        //then
        verify(getRequestedFor(urlPathEqualTo("/locations/v1/cities/neighbors/295954")));
